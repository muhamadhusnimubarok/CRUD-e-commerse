	...
	<div class="wrapper">
		<nav id="sidebar" class="sidebar js-sidebar">
		  ...
		  <i class="align-middle" data-feather="list"></i> <span class="align-middle">Manage</span>
				...
				<li class="sidebar-item {{request()->routeis('admin.cart_history')?'active':''}}">
					<a class="sidebar-link" href="{{route('admin.cart_history')}}">
		  <i class="align-middle" data-feather="shopping-cart"></i> <span class="align-middle">Cart</span>
		</a>
				</li>
				<li class="sidebar-item {{request()->routeis('admin.order_history')?'active':''}}">
					<a class="sidebar-link" href="{{route('admin.order_history')}}">
